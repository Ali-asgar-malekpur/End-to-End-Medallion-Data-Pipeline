...
base_path = f'r2://sportsbar-dp@3be93c912191c1bf8cf7912818757bf4.r2.cloudflarestorage.com/{data_source}/*.csv'
print(base_path)
...
#F.col('month') reads the value and matches with the date
#format showed, if it matches, try_to_date changes it's format
